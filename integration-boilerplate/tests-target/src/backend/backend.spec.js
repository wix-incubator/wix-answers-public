...
var baseUrl = testConfig.baseUrl + ":" + testConfig.apiPort + "/" + testConfig.integrationName;
var initConfig = {
...
var testMongoWrapper = function () {
    var initDB = {};
    var settingsDB = {};
    return {
        registerTenant: function (data) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log('TEASADS');
                if (!initDB[data.tenantId]) {
                    initDB[data.tenantId] = data;
                    return [2 /*return*/, data.tenantId];
                }
                return [2 /*return*/];
            });
        }); },
        getTenantAppKeys: function (tenantId) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, initDB[tenantId] && delete initDB[tenantId]];
        }); }); },
        // ****** INTEGRATION SETTINGS AREA ******/
        saveSettingsPerTenant: function (id, data) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                settingsDB[id] = data;
                return [2 /*return*/, id];
            });
        }); },
        getSettingsPerTenant: function (id) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, settingsDB[id]];
            });
        }); },
        // ****** DELETE INTEGRATION ******/
        removeTenant: function (data) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (initDB[data.tenantId]) {
                    delete initDB[data.tenantId];
                    delete settingsDB[data.tenantId];
                }
...
describe('Integration ', function () { return __awaiter(_this, void 0, void 0, function () {
    var app, testkit, server, dbDriver, collection, integrationConfig;
    var _this = this;
    return __generator(this, function (_a) {
        app = express();
        collection = function (_) { return null; };
        integrationConfig = {
            integrations: {
                integrationName: {
            ...
            mongodb: {
                ...
                initDataDB: testConfig.mongo.initDataDB,
                settingsDB: testConfig.mongo.settingsDB
            }
        };
        before(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dbDriver = testMongoWrapper();
                        return [4 /*yield*/, wix_answers_integrations_testkit_1.createTestkit(initConfig)];
                    case 1:
                        testkit = _a.sent();
                        return [4 /*yield*/, backend_1.initAnswersApi(app, baseUrl, dbDriver, integrationConfig)];
                    case 2:
                        _a.sent();
